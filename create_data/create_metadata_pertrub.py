...
if GLOBAL_LIST:
  ...
  lists_root_dir = "/home/lionb/single_cell_training_from_segmentation_pertrub/"
#what organelles to process
organelles={"Golgi":[],"Microtubules":[],"Nuclear-envelope":[],"Actin-filaments":[],"Plasma-membrane":[],"Nucleolus-(Dense-Fibrillar-Component)":[],"Mitochondria":[],"Endoplasmic-reticulum":[],"Tight-junctions":[],"Nucleolus-(Granular-Component)":[],"Actomyosin-bundles":[],"Desmosomes":[]}
