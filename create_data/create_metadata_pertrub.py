...
if GLOBAL_LIST:
  ...
  lists_root_dir = "/sise/assafzar-group/assafzar/full_cells_fovs_perturbation/train_test_list/"
#what organelles to process
organelles="/sise/assafzar-group/assafzar/full_cells_fovs_perturbation/" #{"Golgi":[],"Microtubules":[],"Nuclear-envelope":[],"Actin-filaments":[],"Plasma-membrane":[],"Nucleolus-(Dense-Fibrillar-Component)":[],"Mitochondria":[],"Endoplasmic-reticulum":[],"Tight-junctions":[],"Nucleolus-(Granular-Component)":[],"Actomyosin-bundles":[],"Desmosomes":[]}
