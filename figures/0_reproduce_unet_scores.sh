...
#SBATCH --job-name 0_reproduce_unet_scores			### name of the job
#SBATCH --output 0_reproduce_unet_scores-%J.out			### output log for running job - %J for job number
...
python /sise/home/lionb/cell_generator/figures/0_reproduce_unet_scores.py
