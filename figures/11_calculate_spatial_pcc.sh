...
#SBATCH --job-name calculate_spatial_pcc.py			### name of the job
#SBATCH --output calculate_spatial_pcc-%J.out			### output log for running job - %J for job number
...
python /sise/home/lionb/cell_generator/figures/calculate_spatial_pcc.py
