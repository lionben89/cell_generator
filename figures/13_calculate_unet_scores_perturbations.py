...
batch_size = 4    
path = "/sise/assafzar-group/assafzar/full_cells_fovs_perturbation/train_test_list/**/image_list_with_metadata__with_efficacy_scores_full.csv"
...
if not dfs:
    ...
    base_dir = "/sise/assafzar-group/assafzar/full_cells_fovs_perturbation/train_test_list/unet_predictions"
...
# ds_path = "/sise/assafzar-group/assafzar/full_cells_fovs_perturbation/train_test_list/unet_predictions/dataset.csv"
for param in params:
    try:
        print(param["model"])
