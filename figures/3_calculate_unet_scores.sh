...
#SBATCH --job-name calculate_unet_scores.py			### name of the job
#SBATCH --output calculate_unet_scores-%J.out			### output log for running job - %J for job number
...
python /sise/home/lionb/cell_generator/figures/calculate_unet_scores.py
