...
if not dfs:
    ...
    metadata_with_efficacy_scores_df.to_csv("/groups/assafza_group/assafza/full_cells_fovs/train_test_list/image_list_with_metadata__with_efficacy_scores_full_all.csv", index=False)
    ...
    plt.tight_layout()
    plt.savefig('/home/lionb/figures/unique_values_plot.png')
    plt.show()
...
def plot_box_plots(data, columns, params):
    ...
    for x_col in tqdm(columns):
        ...
        for idx, param in enumerate(params):
            ...
            train_test_df = pd.read_csv(f"/groups/assafza_group/assafza/full_cells_fovs/train_test_list/{control_organelle}/image_list_with_metadata__with_efficacy_scores_full.csv")
        ...
        plt.savefig(f'/home/lionb/figures/{x_col}_comparison_main.png', bbox_inches='tight',pad_inches=0.05)
        plt.close()
...
def plot_nested_boxplots(data, col1, col2, params):
    ...
    for param in tqdm(params, desc="Processing organelles"):
        ...
        plt.tight_layout()
        plt.savefig(f'/home/lionb/figures/{param["organelle"]}_nested_{col1}_{col2}.png', 
                    dpi=300)
        plt.close()
