...
#SBATCH --job-name generate_outliers_mask_efficacy_images.py			### name of the job
#SBATCH --output generate_outliers_mask_efficacy_images-%J.out			### output log for running job - %J for job number
...
python /sise/home/lionb/cell_generator/figures/generate_outliers_mask_efficacy_images.py
