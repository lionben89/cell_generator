...
#SBATCH --job-name histogram_pca.py			### name of the job
#SBATCH --output histogram_pca-%J.out			### output log for running job - %J for job number
...
python /sise/home/lionb/cell_generator/figures/histogram_pca.py
