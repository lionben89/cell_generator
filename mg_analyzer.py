...
-------------------
    ...
    analyze_correlations_constant(organelles, mask_th, save_image, ...):
        Evaluate importance of organelle pixels vs. random pixels.
        Compares PCC when noising: mask regions, organelle regions, random regions.
        
        Output: corr_results_*.csv with detailed correlation metrics
    
    analyze_predictions(organelle, save_image, compound, is_vehicle, ...):
        Calculate PCC between predictions and ground truth for specific organelle.
        
        Output: predictions_results_*.csv
...
def analyze_predictions(organelle,save_image=True,compound=None,is_vehicle=False,model_path=gv.model_path,model=None):
