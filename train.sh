...
#SBATCH --mail-user=sarithol@post.bgu.ac.il      ### users email for sending job status
...
# export SLURM_SCRATCH_DIR=/scratch/sarithol@auth.ad.bgu.ac.il/${SLURM_JOB_ID}/single_cells_fovs
...
python /sise/home/sarithol/cell_generator/train.py
